...
# Household Features
hhoutpath = DATA_DIR / f'HouseholdFeatures_{today}.pkl'
df_households = pd.read_sql(sql_households,cnxn)
df_households.to_pickle(hhoutpath)

# Head of Household Features
hohoutpath = DATA_DIR / f'HeadofHousholdFeatures_{today}.pkl'
...
lhoutpath = DATA_DIR / f'HouseholdLiteralHomelessnessHistory_{today}.pkl'
